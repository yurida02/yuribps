            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <!-- form start -->
                            <form action="<?= site_url('/biodata/update/' . $biodata['sobat_id']) ?>" method="post">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="_method" value="PUT">
                                <input type="hidden" name="id" value="<?= $biodata['sobat_id']; ?>">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="<?= old('sobat_id', $biodata['sobat_id']); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="<?= old('username', $biodata['username_sobat']); ?>"> <!-- Use the correct field name -->
